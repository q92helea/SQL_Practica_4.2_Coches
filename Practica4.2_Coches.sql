...
/*2.Matricula es cuatro n�meros y tres letras o bien una o dos letras, un gui�n, cuatro
n�meros, un gui�n y una o dos letras. (Ejs: 2345DFV, M-2332-NV,SE-3445-DF)*/
ALTER TABLE coches ADD (
...
dscrp VARCHAR2(150),
/* 5. Las Horas MO de una operaci�n nunca pasan de 4*/
hr_mon NUMBER (1)
);
